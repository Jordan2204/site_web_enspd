...
@section('title')
  ...
  @section('apresHome')
    UserManage/CreateRespEcoleDoct
  @endsection
    ...
    <div class="col-md-9 col-lg-7">
        <div class="card card-primary">   
            <div class="card-header">
                <h3 class="card-title"> Création du responsable du responsable de l'ecole doctorale</h3>
            </div>
            <div class="card-body"> 
                <div class="col-sm-12">
                    {!! Form::open(['route' => 'respEcoleDoct.store', 'class' => 'form-horizontal panel']) !!}   
                    ...
                    <div class="form-group {!! $errors->has('poste') ? 'has-error' : '' !!}">
                        ...
                        {!! $errors->first('poste', '<small class="help-block" style="color: red;">:message</small>') !!}
